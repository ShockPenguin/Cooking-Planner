...
- [ ] Write tests for core logic (`missing_ingredients`, `is_feasible`, `pick_store`)
- [ ] Consider dietary restriction tags (vegetarian, gluten-free, dairy-free)
- [ ] Consider a `pantry add <ingredient_id>` command for updating `pantry.yaml` from the CLI
